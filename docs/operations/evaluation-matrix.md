...
| E-N01 | Rust native migration probe                              | `pnpm run verify:native`                                    | Pinned toolchain, formatting, Clippy, locked tests, stdio `tools/list`, and the bounded Node/Rust corpus fixture pass; remaining R0-R6 gates stay open. |
