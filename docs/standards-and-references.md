...
| Dependency updates    | [Dependabot configuration](https://docs.github.com/en/code-security/dependabot/dependabot-version-updates/configuration-options-for-the-dependabot.yml-file) | Defines ecosystem discovery, schedules, grouping, and pull-request behavior.                                       |
| Dependency review     | [GitHub dependency review](https://docs.github.com/en/code-security/supply-chain-security/understanding-your-software-supply-chain/about-dependency-review)  | Defines the pull-request comparison used to reject newly introduced vulnerable dependencies.                       |
